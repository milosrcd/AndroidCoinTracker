package com.example.milos.androidcointracker;
...
import com.example.milos.androidcointracker.Adapter.CoinAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadFirst10Coin(int index) {
        client = new OkHttpClient();
        request = new Request.Builder().url(String.format("https://api.coinmarketcap.com/v1/ticker/?limit=10", index))// index
                .build();
        swipeRefreshLayout.setRefreshing(true);
        client.newCall(request)
                .enqueue(new Callback() {
